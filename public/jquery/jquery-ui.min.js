            ...
            return (
                ...
                this.each(function () {
                    var i,
                        ...
                        e = A(this, "marginLeft"),
                        s = A(this, "marginTop"),
                        n = l + e + A(this, "marginRight") + y.width,
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        a = -2 * e.offset[0];
                    l < 0
                        ? ((s = t.left + u + i + a + e.collisionWidth - n - s) <
                              0 ||
                              s < E(l)) &&
                          (t.left += u + i + a)
                        : 0 < r &&
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        a = -2 * e.offset[1];
                    l < 0
                        ? ((s = t.top + u + i + a + e.collisionHeight - n - s) <
                              0 ||
                              s < E(l)) &&
                          (t.top += u + i + a)
                        : 0 < r &&
